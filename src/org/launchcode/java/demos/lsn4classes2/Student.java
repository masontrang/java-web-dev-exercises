...
public class Student {
    ...
    public void addGrade(int courseCredits, double grade) {
        ...
        double currentTotalQualityScore = (this.gpa * this.numberOfCredits) + (courseCredits * grade);
    ...
    public String toString(){
        return "Student: "+ name + ", StudentID: "+ studentId + ", Credits: " + numberOfCredits + ", GPA: " + gpa + ")";
    }
